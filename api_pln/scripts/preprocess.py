...
with open('./model/vectorizerNOVA_VERSAO.pkl', 'rb') as file:  # Carrega o modelo treinado com pickle
   vectorizer = pickle.load(file)

print(vectorizer)

# Testanto com novos dados
texto = "naõ gosto disso do comentário que você fez ao meu respeito"
